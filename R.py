...
def S1():
	...
	e = ";[FBAN/FB4A;FBAV/309.0.0.47.119;FBBV/277444756;FBDM/{density=1.0,width=720,height=1600};FBLC/de_DE;FBRV/279865282;FBCR/Willkommen;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A035M;FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
	ua = s + e	
	return ua
...
def rd(ids,passlist):
	try:
		...
		for pas in passlist:                                          
			...
			ua = 'Mozilla/5.0 (Linux; Android 11; Linux; Android 11;N9805L) AppleWebKit/637.36 (KHTML, like Gecko)99.0.13175.111 Chrome/86.0.4350.185 Mobile Safari/637.36 [FB_IAB/FB4A;FBAV/294.6.0.59.118;]'			
